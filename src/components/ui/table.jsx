...
const TableHeader = React.forwardRef(({ className = '', ...props }, ref) => (
  <thead ref={ref} className={`border-b border-slate-800 bg-slate-900/40 ${className}`} {...props} />
));
...
const TableFooter = React.forwardRef(({ className = '', ...props }, ref) => (
  <tfoot
    ref={ref}
    className={`border-t border-slate-800 bg-slate-900/55 font-medium [&>tr]:last:border-b-0 ${className}`}
    {...props}
  />
));
...
const TableCell = React.forwardRef(({ className = '', ...props }, ref) => (
  <td
    ref={ref}
    className={`p-4 align-middle [&:has([role=checkbox])]:pr-0 text-slate-300 ${className}`}
    {...props}
  />
));
